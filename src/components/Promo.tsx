    ...
    >
      <div className="fixed top-[-10vh] left-0 h-[120vh] w-full">
        <motion.div style={{ y }} className="relative w-full h-full">
          <img
            src="https://cdn.poehali.dev/projects/0be03b5b-e30e-49c0-a4f2-41aa3891d977/files/285dfaa8-3e2e-4fbf-9c63-fb84da95eaeb.jpg"
            alt="Здоровое спортивное питание"
      ...
      <p className="absolute bottom-12 right-6 text-white text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl max-w-xs sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-3xl z-10 leading-tight font-light">
        Правильное питание — это не диета. Это система, которая работает на твой результат каждый день.
      </p>
    </div>
  );
}
